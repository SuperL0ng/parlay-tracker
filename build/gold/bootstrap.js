(() => {
  ...
  const requiredGlobals=['ParlayStorage','ParlayTrackerSources','ParlayTrackerEvaluator','ParlaySettlementService','TrackerService','BuilderController','SharingController','TicketViewController','DashboardController','AppController'];
  ...
  async function create(){
    ...
    const instance=Object.freeze({storage,tracker,builder,sharing,viewer,dashboard,app});window.parlayApp=instance;window.dispatchEvent(new CustomEvent('parlay:app-ready'));return instance;
  }
